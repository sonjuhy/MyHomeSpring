...
@Component
public class CloudPrivateFailedTasklet implements Tasklet {
    private final static String TOPIC_CLOUD_CHECK_LOG = "cloud-check-log";
    @Autowired
    private LogComponent logComponent;
    @Override
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        logComponent.sendLog("Cloud-Check", "cloud private fileswalk was failed", false, TOPIC_CLOUD_CHECK_LOG);
